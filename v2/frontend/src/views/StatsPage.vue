    ...
    <el-row :gutter="20" class="stats-row">
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          ...
          <div class="stat-info">
            <div class="stat-value" style="color: #e6a23c;">{{ stats.review_count || 0 }}</div>
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          ...
          <div class="stat-info">
            <div class="stat-value" style="color: #f56c6c;">{{ stats.reject_count || 0 }}</div>
      ...
      <el-col :span="12">
        <el-card>
          ...
          <div class="rate-item">
            ...
            <el-progress 
              :percentage="Math.round((stats.reject_rate || 0) * 100)" 
              color="#f56c6c"
              :stroke-width="18"
            />
          </div>
          <div class="rate-item">
            ...
            <el-progress 
              :percentage="Math.round(((stats.review_count || 0) / (stats.total_reviews || 1)) * 100)" 
              color="#e6a23c"
              :stroke-width="18"
            />
          </div>
      ...
      <el-col :span="12">
        <el-card>
          ...
          <div class="rate-item">
            ...
            <el-progress 
              :percentage="Math.round(((stats.pending_manual || 0) / (stats.review_count || 1)) * 100)" 
              color="#409eff"
              :stroke-width="18"
            />
